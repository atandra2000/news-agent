...
Cost safety via a token counter so the agent stays alive (HERMES_DESIGN §11.2).
"""
...
from hermes.llm.providers.registry import ModelRegistry
from hermes.llm.roles import get_role, get_role_for_provider
