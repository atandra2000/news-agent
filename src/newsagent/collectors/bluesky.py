"""Bluesky (AT Protocol) collector. Env-gated on NEWSAGENT_BLUESKY_HANDLE + NEWSAGENT_BLUESKY_APPKEY; skips when unset (NEWSAGENT_DESIGN §11.2)."""
...
class BlueskyCollector(CollectorAdapter):
    ...
    async def collect(self, *, since: datetime, limit: int = 50) -> list[RawItem]:
        handle = os.environ.get("NEWSAGENT_BLUESKY_HANDLE")
        appkey = os.environ.get("NEWSAGENT_BLUESKY_APPKEY")
