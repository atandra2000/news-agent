...
use; set NEWSAGENT_COLLECTOR_CONTEXT7_API_KEY for higher limits. Skip-safe.
"""
            ...
            async with sem:
                try:
                    ...
                    if s.status_code == 429:
                        log.warning("context7.rate_limited", hint="set NEWSAGENT_COLLECTOR_CONTEXT7_API_KEY for higher limits")
                        return None
