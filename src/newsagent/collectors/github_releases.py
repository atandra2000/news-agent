...
# Curated AI/ML repos shipping meaningful releases. ~20 to stay under GitHub's 60 req/hr unauth limit; set NEWSAGENT_COLLECTOR_GITHUB_TOKEN for more.
DEFAULT_REPOS = [
    # Frontier model labs
...
class GitHubReleaseCollector(CollectorAdapter):
    ...
    async def collect(self, *, since, limit: int = 50) -> list[RawItem]:
        ...
        headers = {
            ...
            "User-Agent": "newsagent-collector/1.0",
        }
