...
from :mod:`newsagent.llm.catalog` so the fleet points at real models; repoint in one place.
"""
...
from newsagent.llm.catalog import TIER_KEEP_ALIVE, TIER_NUM_CTX, OLLAMA_CATALOG, OPENCODE_GO_CATALOG
